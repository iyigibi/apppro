    ...
    let renderLeftContent = () => {
      ...
      if (index > 0) {
        return <RkButton
          ...
          <RkText rkType='awesome hero white_'>{FontAwesome.chevronLeft}</RkText>
        </RkButton>
      }
      else {
        return <RkButton
          ...
          <RkText rkType='awesome white_'>{FontAwesome.bars}</RkText>
        </RkButton>
      }
    };
  ...
  _renderTitle(title, headerTitle) {
    ...
    return (
      <View style={styles.title} onLayout={onLayout}>
        <RkText rkType='white_'>{title}</RkText>
      </View>
    )
  }

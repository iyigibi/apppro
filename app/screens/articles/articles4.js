...
export class Articles4 extends React.Component {
  ...
  renderPage(image, index) {
   // console.log(image);
    return (
        <View key={index} >
            <Image style={{ width: BannerWidth, height: BannerHeight }} source={{ uri: "https://v1.eduacdn.com/v01/600x390/"+image.newsImageName }} />
...
renderTab = (isSelected, title,first=false) => {
  ...
  _renderItem(info) {
    if(info.item.ID=="topGal"){
      ...
      let pho="https://v1.eduacdn.com/v01/220x130/"+info.item.newsImageName;
      let pho2="https://v1.eduacdn.com/v01/800x600/"+info.item.newsImageName;
